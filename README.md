<img align="center" src="https://capsule-render.vercel.app/api?type=waving&color=timeGradient&height=200&section=header&text=JaeHyeon%20Park&desc=N.recreate%208&descAlignY=20&fontSize=120" width="100%"/>
...
예)
  <p>
    <div style="width: 40%; float: left;">
      <a href="https://github.com/N-Recreate8/저장소 이름">
        <img src="https://github-readme-stats.vercel.app/api/pin/?username=N-Recreate8&repo=저장소 이름&theme=dark" alt="프로젝트 저장소 이미지" />
      </a>
    </div>
    <div style="width: 50%; margin-left: 5%; float: left; text-align: left;">
      <h3>@@@ 프로젝트 설명:</h3>
      <p>다양한 프로그래밍 언어와 기술에 대한 스타일 가이드를 제공합니다.</p>
      <p>더 자세한 내용은 저장소에서 확인할 수 있습니다.</p>
      <a href="https://github.com/N-Recreate8/저장소 이름">저장소 바로가기</a>
    </div>
  </p> 
-->
